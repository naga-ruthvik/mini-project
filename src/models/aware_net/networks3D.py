...
def get_scheduler(optimizer, opt):
    if opt.lr_policy == "lambda":
        ...
        scheduler = lr_scheduler.StepLR(
            optimizer, step_size=opt.lr_decay_iters, gamma=0.2
        )
    ...
    elif opt.lr_policy is None or opt.lr_policy == "None":
        return None
    else:
...
def define_Cls(
    class_num=2, init_type="normal", init_gain=0.02, gpu_ids=[], joint=False
):
